...
Brand assets in [`assets/`](assets/) are covered by the same license. The JetBrains Mono typeface used to outline the wordmark is separately OFL-licensed - see [`assets/BRAND.md`](assets/BRAND.md) for typography sourcing.
