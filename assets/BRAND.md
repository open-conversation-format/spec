...
The OCF wordmark and these brand assets are released under the same license as the OCF specification (currently MIT, placeholder until v0.1.0 stable). JetBrains Mono is OFL-licensed by JetBrains s.r.o. — see the typography section above for source links.
